    ...
    return (
        <div>
            <footer className="footer xl:px-24 py-10 px-4 text-base-content bg-[#FAFAFA]">
                ...
                <nav>
                    <header className="footer-title text-black">
                        Useful links
                    </header>
                    <a
                        className="link link-hover hover:text-black hover:no-underline"
                        href="/"
                    >
                        About us
                    </a>
            ...
            <hr />
            <footer className="footer items-center xl:px-24 px-4 py-4 pt-2 bg-white">
