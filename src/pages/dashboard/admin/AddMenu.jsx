...
const AddMenu = () => {
    ...
    return (
        <div className="card text-neutral-content w-auto bg-gray-200">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="form-control w-full my-6">
                                    ...
                                    <select
                                        ...
                                        className="select select-bordered bg-white border-black text-black"
                            ...
                            <div className="form-control">
                                ...
                                <textarea
                                    ...
                                    className="textarea textarea-bordered h-24 bg-white border-black"
                            ...
                            <div className="form-control w-full my-6">
                                <input
                                    ...
                                    type="file"
                                    className="file-input w-full max-w-xs bg-white border-black"
                                />
                            </div>

                            <button className="btn bg-[#ff9933] rounded-full border-none hover:bg-[#ff9933] text-white px-6">
                                <FaUtensils /> Add Item
                            </button>
                        </form>
                    </div>
